...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		clusterers.add(clusterer6);
		
		// KMeans
		ResponsibilitiesClusterer clusterer7 = new DummyResponsibilitiesClusterer("",filterArguments,true, "KMeans");
		clusterers.add(clusterer7);
		...
		for (ResponsibilitiesClusterer clusterer : clusterers){
			clusterer.clusterization("resources", 2);
